import HeroineImg from"../assets/heroine.png";
    ...
    return <section className="flex flex-col md:flex-row px-5 py-32 bg-secondary justify-center">
        ...
        <h1 className=" text-white text-6xl font-hero-font">
            ...
            <div className="flex py-10">
                ...
                <a href={config.social.link} className="hover:text-white"><AiOutlineLinkedin size={40}/></a>
                </div>
                </div>
        <img className="md:w-1/3 " src = {HeroineImg}/>
    </section>
}